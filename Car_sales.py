...
This app predicts the **Car Sales Performance** type!
""")
   
st.image('CarSales.png', caption='CAR SALES')

Manufacturer, Model, Resale_Value, Vehicle_type, Price_in_thousands, Engine_size, Horsepower, Wheelbase, Width, Length, Curb_weight, Fuel_capacity, Fuel_efficiency, Power_perf_factor = user_input_features()
